...
while True:
    ...
    url = main_api + urllib.parse.urlencode({"key": key, "from":orig,"routeType": routeType ,"to":dest, "hasTollRoad":False})
    print("URL: " + (url))
    ...
    if json_status == 0:
        ...
        for each in json_data["route"]["legs"][0]["maneuvers"]:
            ...
            est_time = each["formattedTime"]

            print((each["narrative"]) + " || (Distance: " + str("{:.2f}".format(distance)) + " " + unit + ") || (Estimated Time: " + est_time + ")") 
